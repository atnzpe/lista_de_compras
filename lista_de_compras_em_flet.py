...
class ListaComprasApp(ft.UserControl):
    def __init__(self):
        ...
        self.view = ft.Column(
            [
                ft.Text("Bem-vindo à Lista de Compras!", size=20),
                ft.ElevatedButton("Login", on_click=self.abrir_modal_login),
                ft.ElevatedButton("Incluir Item", on_click=self.abrir_modal_adicionar_item, disabled=True),
                ft.ElevatedButton("Excluir Item", on_click=self.abrir_modal_apagar_item, disabled=True),
                ft.ElevatedButton("Listar Produtos", on_click=self.abrir_modal_listar_produtos, disabled=True),
                ft.ElevatedButton("Comprar Itens", on_click=self.abrir_modal_comprar_itens, disabled=True),
    ...
    def atualizar_estado_botoes(self):
        ...
        self.view.controls[5].disabled = not logado  # Comprar Itens 
        ...
        self.dlg_login = ft.AlertDialog(
            ...
            content=ft.Column(
                [
                    ...
                    ft.TextField(label="Forma de Pagamento", ref=ft.Ref[str]()),
                    ft.TextField(label="Informe o endereço (logradouro, nro - bairro - cidade/sigla estado)", ref=ft.Ref[str]()),
    ...
    def fazer_login(self, e):
        ...
        try:
            self.usuario_atual = self.lista.criar_usuario(nome, cpf, forma_pagamento, endereco, email)
    ...
    def abrir_modal_adicionar_item(self, e):
        self.dlg_adicionar_item = ft.AlertDialog(
            ...
            content=ft.Column(
                [
                    ft.TextField(label="Digite o Nome do Produto", ref=ft.Ref[str]()),
                    ft.TextField(label="Ditie a Quantidade", ref=ft.Ref[str]()),
                    ft.TextField(label="Digite o Valor Unitário", ref=ft.Ref[str]()),
                ]
            ),
            actions=[
                ft.TextButton("Cancelar", on_click=self.fechar_modal),
    ...
    def adicionar_item(self, e):
        ...
        if self.usuario_atual:
            try:
                ...
                self.lista.incluir_produto(nome, quantidade, valor_unitario,valor_total)
    ...
    # ... (Funções para outros modais: abrir_modal_apagar_item, abrir_modal_listar_produtos, etc.)
        ...
        self.dlg_apagar_item = ft.AlertDialog(
            ...
            content=ft.Column(
                [
                    ...
                    ft.TextField(label="Índice ou Nome", ref=ft.Ref[ft.TextField]()),
                ]
            ),
            actions=[
                ft.TextButton("Cancelar", on_click=self.fechar_modal),
                ft.ElevatedButton("Apagar", on_click=self.confirmar_apagar_item),
            ],
            actions_alignment=ft.MainAxisAlignment.END,
        )
    ...
    def abrir_modal_listar_produtos(self, e):
        ...
        itens_lista = [
            ft.ListTile(
                ...
                subtitle=ft.Text(
                    f"Quantidade: {produto.quantidade}, Valor Total do Item: {produto.valor:.2f}"
                ),
            )
